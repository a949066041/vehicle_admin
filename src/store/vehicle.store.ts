...
const initData: Vehicle[] = [
  { id: 1, car_num: '冀F2398学', car_name: '捷达', car_type: 'C1', car_year: 2020, mileage: 1000, car_photo: CAR_IMG, status: VehicleStatus.Idle },
  ...
  { id: 5, car_num: '冀F3467学', car_name: '捷达', car_type: 'C1', car_year: 2020, mileage: 5082, car_photo: CAR_IMG, status: VehicleStatus.Idle },
  ...
  { id: 8, car_num: '冀F3501学', car_name: '哪吒EV', car_type: 'C2', car_year: 2024, mileage: 980, car_photo: CAR_IMG2, status: VehicleStatus.Idle },
  { id: 9, car_num: '冀F3512学', car_name: '比亚迪秦', car_type: 'C2', car_year: 2022, mileage: 3200, car_photo: CAR_IMG2, status: VehicleStatus.Idle },
  { id: 10, car_num: '冀F3520学', car_name: '捷达', car_type: 'C1', car_year: 2018, mileage: 12500, car_photo: CAR_IMG, status: VehicleStatus.Applied },
...
export const useVehicleStore = createGlobalState(() => {
  return useCurd<Vehicle>({ key: 'driving-school-vehicles-v3', initData })
})
